...
Running on an new black nuc:
```
[anderssandstrom@mcag-dev-asm-05-usb ~]$ lshw
WARNING: you should run this program as super-user.
mcag-dev-asm-05-usb.cslab.esss.lu.se
  ...
  *-core
     ...
     *-pci
        ...
        *-communication:0
             ...
             resources: irq:288 memory:df24e000-df24efff
        *-communication:1
        ...
        *-sata
             ...
             resources: irq:127 memory:df248000-df249fff memory:df24c000-df24c0ff ioport:f090(size=8) ioport:f080(size=4) ioport:f060(size=32) memory:df24b000-df24b7ff
        *-pci:0
        ...
        *-multimedia
             ...
             resources: irq:289 memory:df240000-df243fff memory:df220000-df22ffff
        *-serial
             description: SMBus
  ...
  *-network
       ...
       serial: a0:ce:c8:1d:3f:77
       size: 100Mbit/s
       capacity: 100Mbit/s
       capabilities: ethernet physical tp mii 10bt 10bt-fd 100bt 100bt-fd autonegotiation
       configuration: autonegotiation=on broadcast=yes driver=r8152 driverversion=v1.09.9 duplex=full ip=172.30.41.22 link=yes multicast=yes port=MII speed=100Mbit/s
